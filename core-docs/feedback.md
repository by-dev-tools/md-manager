...
**Synthesized rule:** When writing any security test in md-manager, **identify what a real leak/breach would actually output, then assert on THAT**. The path/URL string is a proxy and proxies have escape hatches. Current-surface traps:
